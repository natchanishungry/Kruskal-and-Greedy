...
public class WGraph{
    ...
    public DisjointSets translate()
	{
    		DisjointSets d = new DisjointSets(getNbNodes());
		ArrayList<Integer> n = nodes;
		int i= 0;
		for(Integer node: n)
		{
			//DisjointSets.setRank(d, 0, i);
			//DisjointSets.setPar(d, (int) node, i);
			i++;
		}
		return d;
	}
